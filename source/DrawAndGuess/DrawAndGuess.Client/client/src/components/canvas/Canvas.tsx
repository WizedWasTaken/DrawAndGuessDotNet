...
export default function Canvas() {
    ...
    const floodFill = async (startX: number, startY: number) => {
        ...
        const processStack = async () => {
            while (stack.length) {
                ...
                if (!colorMatch(pos, targetR, targetG, targetB, targetA, pixels))
                    continue;
                ...
                // Yield control back to the browser to update the UI
    ...
    return (
        <main className="p-5 flex flex-grow justify-center gap-5 align-center flex-col overflow-hidden">
